...
const stackingWalletSchema = new mongoose.Schema({
...
stackingWalletSchema.set('timestamps', true)

module.exports = mongoose.model('stakingWallet', stackingWalletSchema, 'stakingWallet')